    ...
    return function t(e, n, o) {
        ...
        1: [function (t, e, n) {
            ...
            try {
                ...
                var r = t("component-matches-selector")
            }
            e.exports = o
        }, {"component-matches-selector": 2, "matches-selector": 2}], 2: [function (t, e, n) {
            function o(t, e) {
                if (!t || 1 !== t.nodeType) return !1;
                if (c) return c.call(t, e);
                for (var n = r.all(e, t.parentNode), o = 0; o < n.length; ++o) if (n[o] == t) return !0;
                return !1
            }
            ...
            try {
                ...
                var r = t("component-query")
            }
            var i = Element.prototype,
                c = i.matches || i.webkitMatchesSelector || i.mozMatchesSelector || i.msMatchesSelector || i.oMatchesSelector;
            e.exports = o
        }, {"component-query": 3, query: 3}], 3: [function (t, e, n) {
            function o(t, e) {
                return e.querySelector(t)
            }

            n = e.exports = function (t, e) {
                return e = e || document, o(t, e)
            }, n.all = function (t, e) {
            ...
            var i = t("component-closest");
            e.exports = o
        }, {"component-closest": 1}], 5: [function (t, e, n) {
            n.node = function (t) {
            ...
            e.exports = o
        }, {"./is": 5, delegate: 4}], 7: [function (t, e, n) {
            function o(t) {
                var e;
                ...
                var r = n(e), i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                    ...
                    return t.prototype.resolveOptions = function t() {
                        ...
                        this.removeFake(), this.fakeHandlerCallback = function () {
                            return e.removeFake()
                        }, this.fakeHandler = document.body.addEventListener("click", this.fakeHandlerCallback) || !0, this.fakeElem = document.createElement("textarea"), this.fakeElem.style.fontSize = "12pt", this.fakeElem.style.border = "0", this.fakeElem.style.padding = "0", this.fakeElem.style.margin = "0", this.fakeElem.style.position = "absolute", this.fakeElem.style[n ? "left" : "right"] = "-9999px";
                        var o = window.pageYOffset || document.documentElement.scrollTop;
                        this.fakeElem.addEventListener("focus", window.scrollTo(0, o)), this.fakeElem.style.top = o + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, document.body.appendChild(this.fakeElem), this.selectedText = (0, r.default)(this.fakeElem), this.copyText()
            ...
            !function (r, i) {
                ...
                var s = r(e), u = r(n), f = r(o), d = function (t) {
                    function e(n, o) {
                        i(this, e);
        ...
        }, {"./clipboard-action": 9, "good-listener": 6, "tiny-emitter": 8}]
    }, {}, [10])(10)
});
...
var clipboard = new Clipboard('.copy', {
    text: function (trigger) {
        return codeLines.filter(function (cL) {
            return cL != ''
        }).join("\n").replace(/\n$/, '');
    }
});
